...
Käyttäjänimi & Merkkijono, max. 20 merkkiä & Käyttäjän nimi sovelluksessa \\ \hline
Salasana & Merkkijono, max. 20 merkkiä & Merkkijono, jolla käyttäjä varmennetaan \\ \hline
\end{tabular}
...
\begin{tabular}{ | l | l | l | p{7.5cm} |} \hline
\textbf{Attribuutti} & \textbf{Arvojoukko} & \textbf{Kuvailu} \\ \hline
Käyttäjä & Merkkijono & Käyttäjän pk \\ \hline
...
Deadline & Päivämäärä & Milloin askare viimeistään suoritettu \\ \hline
...
\textbf{Attribuutti} & \textbf{Arvojoukko} & \textbf{Kuvailu} \\ \hline
Käyttäjä & Merkkijono & Käyttäjän pk \\ \hline
Nimi & Merkkijono, max. 20 merkkiä & Luokan nimi \\ \hline
...
\textbf{Attribuutti} & \textbf{Arvojoukko} & \textbf{Kuvailu} \\ \hline
Käyttäjä & Merkkijono & Käyttäjän pk \\ \hline
Nimi & Merkkijono, max. 20 merkkiä & Tärkeysasteen nimi \\ \hline
